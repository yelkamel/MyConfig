    ...
    return (
      <ScrollView style={styles.container}>
        <ResponsiveImage source={Images.MascotteImg} style={styles.drawerLogo} initWidth="150" initHeight="150" />
          <DrawerButton style={styles.drawerSectionView} text="Les Questions Magiques" onPress={this.handlePressMagicQuestion} />
          <DrawerButton style={styles.drawerSectionView} text="Paramètres" onPress={this.handlePressSetting} />
          <DrawerButton style={styles.drawerSectionView} text="À Propos" onPress={this.handlePressAbout} />
